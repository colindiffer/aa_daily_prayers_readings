  ...
  Future<void> _launchEmail() async {
    final Uri emailUri = Uri(
      ...
      query: Uri.encodeQueryComponent(
        'subject=Feedback about AA Daily Readings & Prayers & Prayers App',
      ),
    );
              ...
              : SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Text(
                        'AA Daily Readings & Prayers & Prayers',
                    ...
                    if (kDebugMode) ...[
                      ...
                      ElevatedButton.icon(
                        ...
                        label: const Text('Rating System Demo'),
  ...
  Future<void> _loadCurrentConsent() async {
    ...
    setState(() {
      _consentOptions = {
        ...
        "analytics":
            consentManager.getConsentState(ConsentType.analytics) ==
  ...
  Future<void> _saveConsent() async {
    ...
    await consentManager.updateAllConsent({
      ConsentType.analytics:
          _consentOptions["analytics"] == true
              ? ConsentState.granted
              : ConsentState.denied,
      ConsentType.adPersonalization:
          _consentOptions["marketing"] == true
              ? ConsentState.granted
              : ConsentState.denied,
