...
class NotificationService {
    ...
    if (Platform.isAndroid) {
      try {
        const AndroidNotificationChannel channel = AndroidNotificationChannel(
          ...
          'AA Daily Readings & Prayers Notifications',
          description: 'Daily reminders for AA Daily Readings & Prayers',
    ...
    try {
      ...
      const AndroidNotificationDetails androidDetails =
          AndroidNotificationDetails(
            ...
            'AA Daily Readings & Prayers Notifications',
            channelDescription:
                'Daily reminders for AA Daily Readings & Prayers',
            importance: Importance.max,
  ...
  Future<void> scheduleDailyNotifications() async {
    try {
      final prefs =
          await SharedPreferences.getInstance(); // Check if notifications are enabled
      ...
      debugPrint(
        "⏰ Setting up daily notifications for ${hour.toString().padLeft(2, '0')}:${minute.toString().padLeft(2, '0')}",
